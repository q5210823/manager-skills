...
负责经纪人 Skill 文件的版本存档和回滚。

用法：
    python version_manager.py --action list --slug example_artist_manager --base-dir ./managers
    python version_manager.py --action rollback --slug example_artist_manager --version v2 --base-dir ./managers
"""
...
def main():
    parser = argparse.ArgumentParser(description="经纪人 Skill 版本管理器")
    parser.add_argument("--action", required=True, choices=["list", "rollback", "cleanup"])
    parser.add_argument("--slug", required=True, help="经纪人 slug")
